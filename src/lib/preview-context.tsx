...
import { X, ChevronRight, Eye, Download } from 'lucide-react'

interface PreviewApi {
  /** Open the in-app side preview panel with the given URL (e.g. /api/pdf/...). */
    ...
    mounted && url
      ? createPortal(
          url && !collapsed ? (
            ...
            <div
              className="fixed inset-y-0 right-0 z-[70] flex w-full max-w-[480px] flex-col border-l border-border bg-card shadow-2xl"
              style={{ height: '100dvh' }}
            >
