...
import { Plus, Search, FileText, Eye, Edit3, Share2, Trash2, Download, IndianRupee, Wallet, TrendingUp, AlertTriangle } from 'lucide-react'
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan={9} className="text-center py-8 text-slate-500">No invoices</TableCell></TableRow>
                ) : filtered.map((inv) => (
